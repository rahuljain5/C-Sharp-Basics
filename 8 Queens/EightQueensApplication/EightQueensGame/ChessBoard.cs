	...
	public partial class ChessBoard : Form
	{
		...
		private void InsertQueen(Label cell)
		{
			...
			if (cell.BackColor == Color.White)
				img = Image.FromFile(@"C:\Users\Rahul Jain\Desktop\8 Queens\EightQueensApplication\EightQueensGame\queens-crown-white.jpg");
			else
                img = Image.FromFile(@"C:\Users\Rahul Jain\Desktop\8 Queens\EightQueensApplication\EightQueensGame\queens-crown-black.jpg");
			cell.Image = img;
			numOfQueens++;
		}
	}
